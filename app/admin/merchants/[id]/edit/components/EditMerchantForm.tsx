...
export function EditMerchantForm({ merchant, location }: EditMerchantFormProps) {
  ...
  const [logoPreview, setLogoPreview] = useState<string | null>(location?.logoUrl || null)
  const [bannerPreview, setBannerPreview] = useState<string | null>(location?.bannerUrl || null)
